...
public class RuleResolver implements Runnable {
    ...
    private static HashMap<String, String> rulesA = new HashMap<String, String>();
    private static HashMap<String, String> rulesAAAA = new HashMap<String, String>();
    ...
    public static void clear() {
        rulesA = new HashMap<String, String>();
        rulesAAAA = new HashMap<String, String>();
    }
